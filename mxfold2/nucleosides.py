...
#    'J': Bases('J', 'U', 'AG', 'CO[C@H]1[C@H]([n]2ccc(=O)[nH]c2=O)O[C@H](CO)[C@H]1O', '2\'-O-methyluridine'),
    ...
    'D': Bases('D', 'U', '', 'OC[C@H]1O[C@@H](N2CCC(=O)NC2=O)[C@H](O)[C@@H]1O', 'dihydrouridine')
}
# fmt: on
...
modomics_nucleosides: Dict[str, Bases] = {
    ...
    'Ѣ': Bases('Ѣ', 'A', 'AG', 'C[n]1c(=N)c2c([n]([C@H]3[C@H](O)[C@H](O)[C@@H](CO)O3)cn2)nc1', '1-methyladenosine'),
    '＃': Bases('＃', 'G', 'CU', 'CO[C@H]1[C@H]([n]2cnc3c2nc(N)[nH]c3=O)O[C@H](CO)[C@H]1O', "2'-O-methylguanosine"),
    '$': Bases('$', 'U', 'A', 'OC(CNCc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=S)[nH]c1=O)=O', '5-carboxymethylaminomethyl-2-thiouridine'),
    ...
    'Щ': Bases('Щ', 'C', '', 'C[n+]1c(N)cc[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c1=O', '3-methylcytidine'),
    ...
    '2': Bases('2', 'U', 'A', 'O[C@H]1[C@H]([n]2ccc(=O)[nH]c2=S)O[C@H](CO)[C@H]1O', '2-thiouridine'),
    '3': Bases('3', 'U', 'A', 'COC(Cc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=S)[nH]c1=O)=O', '5-methoxycarbonylmethyl-2-thiouridine'),
    ...
    '6': Bases('6', 'A', '', 'CC(O)C(N)C(NC(Nc1ncnc2c1nc[n]2[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1O)=O)=O', 'N6-threonylcarbamoyladenosine'),
    ...
    'F': Bases('F', 'U', 'A', 'Cc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=S)[nH]c1=O', '5-methyl-2-thiouridine'),
    'G': Bases('G', 'G', 'CU', 'Nc1[nH]c(=O)c2nc[n]([C@@H]3O[C@H](CO)[C@@H](O)[C@H]3O)c2n1', 'guanosine'),
    'I': Bases('I', 'A', 'UCA', 'OC[C@@H]1[C@@H](O)[C@@H](O)[C@H]([n]2c3nc[nH]c(=O)c3nc2)O1', 'inosine'),
    'J': Bases('J', 'U', 'AG', 'CO[C@H]1[C@H]([n]2ccc(=O)[nH]c2=O)O[C@H](CO)[C@H]1O', "2'-O-methyluridine"),
    'K': Bases('K', 'G', '', 'CN1C(=O)c2[n]c[n]([C@H]3[C@H](O)[C@H](O)[C@@H](CO)O3)c2N=C1N', '1-methylguanosine'),
    ...
    'O': Bases('O', 'A', '', 'C[n]1c(=O)c2c([n]([C@H]3[C@H](O)[C@H](O)[C@@H](CO)O3)cn2)nc1', '1-methylinosine'),
    'P': Bases('P', 'U', 'AGU', 'OC[C@H]1O[C@@H](c2c[nH]c(=O)[nH]c2=O)[C@H](O)[C@@H]1O', 'pseudouridine'),
    'Q': Bases('Q', 'G', 'CU', 'Nc1[nH]c(=O)c2c([n]([C@H]3[C@H](O)[C@H](O)[C@@H](CO)O3)cc2CN[C@@H]2[C@@H](O)[C@@H](O)C=C2)n1', 'queuosine'),
    'R': Bases('R', 'G', 'U', 'CN(C)c1[nH]c(=O)c2nc[n]([C@@H]3O[C@H](CO)[C@@H](O)[C@H]3O)c2n1', 'N2,N2-dimethylguanosine'),
    'S': Bases('S', 'U', 'A', 'CNCc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=S)[nH]c1=O', '5-methylaminomethyl-2-thiouridine'),
    ...
    'W': Bases('W', 'G', '', 'C[n]1c2c(nc[n]2[C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=O)[n]2c1nc(C)c2CC(OO)C(NC(OC)=O)C(OC)=O', 'peroxywybutosine'),
    'X': Bases('X', 'U', '', 'NC(CC[n]1c(=O)[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)ccc1=O)C(O)=O', '3-(3-amino-3-carboxypropyl)uridine'),
    'Y': Bases('Y', 'G', '', 'COC(NC(C(OC)=O)CCc1[n]2c([n](c3c(c2=O)nc[n]3[C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)C)nc1C)=O', 'wybutosine'),
    ...
    'e': Bases('e', 'A', '', 'CC(O)C1NC(=Nc2ncnc3c2nc[n]3[C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)OC1=O', 'cyclic N6-threonylcarbamoyladenosine'),
    'f': Bases('f', 'U', 'A', 'CC(C)=CCC/C(/C)=C/CSc1nc(=O)c(CNCC(O)=O)c[n]1[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1O', '5-carboxymethylaminomethyl-2-geranylthiouridine'),
    'h': Bases('h', 'U', 'A', 'CC(C)=CCC/C(/C)=C/CSc1nc(=O)c(CNC)c[n]1[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1O', '5-methylaminomethyl-2-geranylthiouridine'),
    'l': Bases('l', 'U', 'A', 'NC(Cc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=S)[nH]c1=O)=O', '5-carbamoylmethyl-2-thiouridine'),
    'r': Bases('r', 'U', 'AG', 'NC(C(O)c1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=O)[nH]c1=O)=O', '5-carbamoylhydroxymethyluridine'),
    'y': Bases('y', 'G', '', 'C[n]1c2nc(C)c(CC(O)C(N)C(OC)=O)[n]2c(=O)c2nc[n]([C@@H]3O[C@H](CO)[C@@H](O)[C@H]3O)c12', 'methylated undermodified hydroxywybutosine'),
    '{': Bases('{', 'U', 'AG', 'CNCc1c(=O)[nH]c(=O)[n]([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)c1', '5-methylaminomethyluridine'),
    '|': Bases('|', 'G', 'U', 'CN(C)c1[nH]c(=O)c2nc[n]([C@@H]3O[C@H](CO)[C@@H](O)[C@H]3OC)c2n1', "N2,N2,2'-O-trimethylguanosine"),
    '}': Bases('}', 'C', 'A', 'N[C@H](C(=O)O)CCCCN=c1[n]([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)ccc(N)n1', '2-lysidine'),
    ...
    'Ɲ': Bases('Ɲ', 'U', 'A', 'CC(=CCNCc1c(=O)[nH]c(=S)[n]([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)c1)C', '5-(isopentenylaminomethyl)-2-thiouridine'),
    '¾': Bases('¾', 'U', 'AG', 'CC(=CCNCc1c(=O)[nH]c(=O)[n]([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)c1)C', '5-(isopentenylaminomethyl)uridine'),
    '¿': Bases('¿', 'C', 'A', 'NC(NCCCCNc1nc(=N)cc[n]1[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1O)=N', 'agmatidine'),
    ...
    'Ð': Bases('Ð', 'U', '', 'NC(CCN1C(=O)N([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)CCC1=O)C(O)=O', '3-(3-amino-3-carboxypropyl)-5,6-dihydrouridine'),
    'Þ': Bases('Þ', 'U', '', 'NC(C(=O)O)CC[n]1c(=O)c([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)c[nH]c1=O', '3-(3-amino-3-carboxypropyl)pseudouridine'),
    ...
    'œ': Bases('œ', 'A', 'AG', 'CO[C@H]1[C@H]([n]2c3nc[n](c(=N)c3nc2)C)O[C@H](CO)[C@H]1O', "1,2'-O-dimethyladenosine"),
    'š': Bases('š', 'G', '', 'C[n]1c2c(nc[n]2[C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=O)[n]2c1nc(C)c2CC(O)C(N)C(O)=O', 'undermodified hydroxywybutosine'),
    'Γ': Bases('Γ', 'U', 'A', 'CC(C)=CCC/C(/C)=C/CSc1nc(=O)cc[n]1[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1O', '2-geranylthiouridine'),
    'Δ': Bases('Δ', 'U', 'A', 'CC(C)=CCC/C(/C)=C/CSc1nc(=O)c(CN)c[n]1[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1O', '5-aminomethyl-2-geranylthiouridine'),
    'Z': Bases('Z', 'U', 'AGU', 'CO[C@H]1[C@H](c2c[nH]c(=O)[nH]c2=O)O[C@H](CO)[C@H]1O', "2'-O-methylpseudouridine"),
    'Ƒ': Bases('Ƒ', 'U', '', 'C[n]1c(=O)c([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)c[nH]c1=O', '3-methylpseudouridine'),
    ...
    'α': Bases('α', 'U', '', 'C[n]1c(=O)[n](CCC(C(=O)O)N)c(=O)c([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)c1', '1-methyl-3-(3-amino-3-carboxypropyl)pseudouridine'),
    'β': Bases('β', 'C', '', 'CO[C@H]1[C@H]([n]2c(=O)nc(N(C)C)cc2)O[C@H](CO)[C@H]1O', "N4,N4,2'-O-trimethylcytidine"),
    'γ': Bases('γ', 'G', 'CU', 'CO[C@H]1[C@H]([n]2cnc3c2nc([nH]c3=O)NC)O[C@H](CO)[C@H]1O', "N2,2'-O-dimethylguanosine"),
    'δ': Bases('δ', 'U', '', 'C[n]1c(=O)[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)ccc1=O', '3-methyluridine'),
    'ε': Bases('ε', 'G', '', 'CO[C@H]1[C@H]([n]2c3nc([n](c(=O)c3nc2)C)N)O[C@H](CO)[C@H]1O', "1,2'-O-dimethylguanosine"),
    'ζ': Bases('ζ', 'A', '', 'CN(C)c1ncnc2c1nc[n]2[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1O', 'N6,N6-dimethyladenosine'),
    'η': Bases('η', 'A', '', 'CN(C)c1ncnc2c1nc[n]2[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1OC', "N6,N6,2'-O-trimethyladenosine"),
    'μ': Bases('μ', 'C', '', 'CN(c1nc(=O)[n]([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)cc1)C', 'N4,N4-dimethylcytidine'),
    'ν': Bases('ν', 'C', 'G', 'CNc1nc(=O)[n]([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)cc1', 'N4-methylcytidine'),
    'ξ': Bases('ξ', 'A', '', 'CO[C@H]1[C@H]([n]2c3nc[n](c(=O)c3nc2)C)O[C@H](CO)[C@H]1O', "1,2'-O-dimethylinosine"),
    'π': Bases('π', 'U', 'A', 'NCc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=[Se])[nH]c1=O', '5-aminomethyl-2-selenouridine'),
    'ρ': Bases('ρ', 'U', '', 'CC1C(=O)NC(=O)N([C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)C1', '5-methyldihydrouridine'),
    'ς': Bases('ς', 'G', 'CU', 'Nc1[nH]c(=O)c2c([n]([C@H]3[C@H](O)[C@H](O)[C@@H](CO)O3)cc2CN[C@@H]2[C@@H](O)[C@@H](O)C3C2O3)n1', 'epoxyqueuosine'),
    'σ': Bases('σ', 'U', '', 'C[n]1c(=O)cc[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2OC)c1=O', "3,2'-O-dimethyluridine"),
    ...
    'ω': Bases('ω', 'U', 'A', 'O[C@H]1[C@H]([n]2ccc(=O)[nH]c2=[Se])O[C@H](CO)[C@H]1O', '2-selenouridine'),
    ...
    '†': Bases('†', 'G', '', 'Cc1c[n]2c(c3nc[n]([C@@H]4O[C@H](CO)[C@@H](O)[C@H]4O)c3[nH]c2n1)=O', '4-demethylwyosine'),
    '€': Bases('€', 'G', '', 'C[n]1c2c(nc[n]2[C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=O)[n]2cc(C)nc12', 'wyosine'),
    '℘': Bases('℘', 'U', 'A', 'OC(Cc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=S)[nH]c1=O)=O', '5-carboxymethyl-2-thiouridine'),
    ...
    'ƕ': Bases('ƕ', 'U', 'A', 'OC[C@H]1O[C@@H]([n]2cc(CNCCS(O)(=O)=O)c(=O)[nH]c2=S)[C@H](O)[C@@H]1O', '5-taurinomethyl-2-thiouridine'),
    ...
    '∏': Bases('∏', 'U', 'A', 'CO[C@H]1[C@H]([n]2ccc(=O)[nH]c2=S)O[C@H](CO)[C@H]1O', "2-thio-2'-O-methyluridine"),
    '∑': Bases('∑', 'G', '', 'Cc1c(C)[n]2c([n](c3c(c2=O)nc[n]3[C@H]2[C@H](O)[C@H](O)[C@@H](CO)O2)C)n1', 'methylwyosine'),
    ...
    '∠': Bases('∠', 'G', 'U', 'CN(c1nc(=O)c2c([n]([C@H]3[C@H](O)[C@H](O)[C@@H](CO)O3)c[n+]2C)n1)C', 'N2,N2,7-trimethylguanosine'),
    ...
    '∫': Bases('∫', 'U', 'A', 'NCc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=S)[nH]c1=O', '5-aminomethyl-2-thiouridine'),
    '≅': Bases('≅', 'U', 'A', 'CNCc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=[Se])[nH]c1=O', '5-methylaminomethyl-2-selenouridine'),
    ...
    'Ш': Bases('Ш', 'A', 'UCA', 'CO[C@H]1[C@H]([n]2cnc3c2nc[nH]c3=O)O[C@H](CO)[C@H]1O', "2'-O-methylinosine"),
    ...
    '⊆': Bases('⊆', 'G', '', 'C[n]1c2c(nc[n]2[C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=O)[n]2c1nc(C)c2CC(O)C(NC(OC)=O)C(OC)=O', 'hydroxywybutosine'),
    '⊇': Bases('⊇', 'G', '', 'Cc1nc2[nH]c3c(c(=O)[n]2c1C)nc[n]3[C@@H]1O[C@H](CO)[C@@H](O)[C@H]1O', 'isowyosine'),
    '⊥': Bases('⊥', 'U', 'A', 'OC(CNCc1c[n]([C@@H]2O[C@H](CO)[C@@H](O)[C@H]2O)c(=[Se])[nH]c1=O)=O', '5-carboxymethylaminomethyl-2-selenouridine'),
