...
class MXFold2Objective:
    ...
    def _create_args(
        ...
        args = Namespace(
            ...
            dropout_rate_1d_cnn=params.get("dropout_rate_1d_cnn"),
            dropout_rate_2d_cnn=params.get("dropout_rate_2d_cnn"),
            dropout_rate_lstm=params.get("dropout_rate_lstm"),
            fc_dropout_rate=params["fc_dropout_rate"],
            stochastic_depth_1d=params.get("stochastic_depth_1d"),
            stochastic_depth_2d=params.get("stochastic_depth_2d"),
