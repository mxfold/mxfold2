...
PYBIND11_MODULE(interface, m)
{
    ...
    auto predict_zuker_turner = &predict_zuker<TurnerNearestNeighbor>;
    m.doc() = "module for RNA secondary predicton with DNN";
    m.def("predict_zuker", predict_zuker_turner, 
    ...
    m.def("predict_positional", predict_zuker_positional, 
